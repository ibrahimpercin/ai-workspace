...
public class StartWeka {
	...
	public static void main(String[] args) throws Exception {
		DataSource source = new DataSource("C:\\Program Files\\Weka-3-8\\data\\labor.arff");
		
		Instances trainData = source.getDataSet();
		
		// Setting class attribute
		// classIndex() --> Returns the class attribute's index. Returns negative number if it's undefined.
		...
		+ "\nFNegative => " + eval.falseNegativeRate(1)
		+ " - FPositive => " + eval.falsePositiveRate(1));
	}
